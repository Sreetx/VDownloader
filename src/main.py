...
try:
    ...
    import requests
    print(orange+" [~] Membuat folder untuk unduhan...."+reset)
    ...
    if sys.platform in ['linux', 'linux2']:
        ...
        if pilih.lower() == "y":
            ...
            if pytubes.status_code == 200:
                ...
                os.system('sudo cp -r pytube-15.0.0/pytube /lib/python3.11/')
            else: pass
        else: pass
    else:
    ...
    try:
        ...
        if pilihann.strip() == "V" or pilihann.strip() == 'v':
            ...
            try:
                 ...
                 with open('YouTube/'+str(nama_video) + ".mp4", 'wb') as f:
...
<========================================================>'''+reset+orange+'''
 ...
 | '''+hijau+'''Version:  '''+bputih+''' 0.0.1                                  '''+reset+orange+'''   |
